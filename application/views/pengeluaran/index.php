			    	...
			    	<div class="modal-content text-left">
				      ...
				      <div class="modal-body">
				      	<div class="form-group">
				      		...
				      		<input type="number" id="jumlah_pengeluaran" class="form-control" placeholder="Masukkan Jumlah Pengeluaran" name="jumlah_pengeluaran">
				      	</div>
				      	<div class="form-group">
				      		<label for="keterangan_pengeluaran">Keterangan Pengeluaran</label>
				      		<textarea id="keterangan_pengeluaran" class="form-control" placeholder="Masukkan Keterangan Pengeluaran" name="keterangan_pengeluaran"></textarea>
				      	</div>
				      </div>
									    	...
									    	<div class="modal-content text-left">
										      ...
										      <div class="modal-body">
										      	<div class="form-group">
										      		...
										      		<input type="number" id="jumlah_pengeluaran<?= $dpe['id_pengeluaran']; ?>" class="form-control" placeholder="Masukkan Jumlah Pengeluaran" name="jumlah_pengeluaran" value="<?= $dpe['jumlah_pengeluaran']; ?>">
										      	</div>
										      	<div class="form-group">
										      		<label for="keterangan_pengeluaran<?= $dpe['id_pengeluaran']; ?>">Keterangan Pengeluaran</label>
										      		<textarea id="keterangan_pengeluaran<?= $dpe['id_pengeluaran']; ?>" class="form-control" placeholder="Masukkan Keterangan Pengeluaran" name="keterangan_pengeluaran"><?= $dpe['keterangan_pengeluaran']; ?></textarea>
										      	</div>
										      </div>
										      <div class="modal-footer">
										        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-fw fa-times"></i> Batal</button>
