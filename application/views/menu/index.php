				    	...
				    	<div class="modal-content text-left">
					      ...
					      <div class="modal-body">
							  ...
							  <div class="form-group">
					      		...
					      		<input type="number" id="harga_modal" class="form-control" placeholder="Masukkan Harga Modal" name="harga_modal" required>
					      	</div>
					      	<div class="form-group">
					...
					<tbdody>
						...
						<?php foreach ($menu as $dm): ?>
							<tr>
								...
								<td class="text-left">Rp. <?= number_format($dm['harga_modal']); ?></td>
										    ...
										    <form action="<?= base_url('main/editMenu/' . $dm['id_menu']); ?>" method="post">
										    	<div class="modal-content text-left">
											      ...
											      <div class="modal-body">
													  ...
													  <div class="form-group">
											      		<label for="harga_modal<?= $dm['id_menu']; ?>">Harga Modal</label>
											      		<input type="number" id="harga_modal<?= $dm['id_menu']; ?>" class="form-control" placeholder="Masukkan Harga Modal" name="harga_modal" value="<?= $dm['harga_modal']; ?>" required>
											      	</div>
											      	<div class="form-group">
