...
class Prints extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('Pemasukkan_model', 'pemamo');
	...
	public function laporanPemasukkan($tanggal_awal, $tanggal_akhir)
	{
		$this->lm->addLog('Print Laporan Pemasukkan dari tanggal' . $tanggal_awal . ' sampai ' . $tanggal_akhir, $this->mm->dataUser()['id_user']);
		$data['title'] = 'Print Laporan Pemasukkan - ' . $tanggal_awal . ' sampai ' . $tanggal_akhir;
		$data['pemasukkan'] = $this->pemamo->getPemasukkanTgl(date($tanggal_awal), date($tanggal_akhir));
		...
		$data['tanggal_akhir'] = $tanggal_akhir;
		$this->load->view('templates/header', $data);
		$this->load->view('prints/laporanPemasukkan', $data);
		$this->load->view('templates/footer', $data);
	}
}
